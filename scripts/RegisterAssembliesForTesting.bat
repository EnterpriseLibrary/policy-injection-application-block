...
@REM ------------------------------------------------------------------
cd ..\bin\%buildType%
if Exist EnterpriseLibrary.PolicyInjection.dll installutil %action% /LogToConsole=%logToConsole% /Category="Call Handler Unit Tests" EnterpriseLibrary.PolicyInjection.dll 
@if errorlevel 1 goto :error
popd
pushd %binDir%
cd ..\Source\Tests\PolicyInjection\bin\%buildType%
if Exist EnterpriseLibrary.PolicyInjection.Tests.dll installutil %action% /LogToConsole=%logToConsole% EnterpriseLibrary.PolicyInjection.Tests.dll
@if errorlevel 1 goto :error
popd
