...
namespace EnterpriseLibrary.Logging.Tests.PolicyInjection
{
    ...
    public class CategoryFormatterFixture
    {
        ...
        public void ShouldReplaceNamespace()
        {
            ...
            Assert.AreEqual("Namespace EnterpriseLibrary.Logging.Tests.PolicyInjection",
                            formatted);
        }
        ...
        public void ShouldReplaceAssembly()
        {
            ...
            Assert.IsTrue(formatted.StartsWith("Assembly EnterpriseLibrary.PolicyInjection.CallHandlers.Tests"));
        }
