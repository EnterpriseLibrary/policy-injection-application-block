...
using EnterpriseLibrary.PolicyInjection.TestSupport;
using EnterpriseLibrary.Validation.Configuration;
using EnterpriseLibrary.Validation.PolicyInjection;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using Unity.Interception.Interceptors;
using ValidationCallHandler = EnterpriseLibrary.Validation.PolicyInjection.ValidationCallHandler;

namespace EnterpriseLibrary.PolicyInjection.CallHandlers.Tests.Configuration
{
    [TestClass]
