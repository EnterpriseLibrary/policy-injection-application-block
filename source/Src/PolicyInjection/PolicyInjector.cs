...
namespace EnterpriseLibrary.PolicyInjection
{
    /// <summary>
    ...
    public class PolicyInjector : IDisposable
    {
        ...
        private void Initialize(IUnityContainer container)
        {
            ...
            IInstanceInterceptor interceptor = new Unity.Interception.Interceptors.InstanceInterceptors.TransparentProxyInterception.TransparentProxyInterceptor();
#else
            ...
            this.instanceInterceptionPolicySettingInjectionMember =
                new InstanceInterceptionPolicySettingInjectionMember(interceptor);
        }
        ...
        public object Wrap(Type typeToReturn, object instance)
        {
            ...
            Guard.InstanceIsAssignable(typeToReturn, instance, "instance");
